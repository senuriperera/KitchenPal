  ...
  deleteUser(user: User): void {
    ...
    this.userService.deleteUser(user.id).subscribe({
      ...
      error: (error) => {
        ...
        this.userErrorMessage =
          error.error?.error || 'Failed to delete user. Please try again.';
        this.isLoading = false;
      },
    });
  }
  ...
  submitBranch(): void {
    ...
    this.branchService.createBranch(branchData).subscribe({
      ...
      error: (error) => {
        ...
        this.branchErrorMessage =
          error.error?.error || 'Failed to create branch. Please try again.';
        this.isLoading = false;
      },
    });
  }
  ...
  deleteBranch(branch: Branch): void {
    ...
    this.branchService.deleteBranch(branch.id).subscribe({
      ...
      error: (error) => {
        ...
        this.branchErrorMessage =
          error.error?.error || 'Failed to delete branch. Please try again.';
        this.isLoading = false;
      },
    });
  }
